...
class WordGenerator {
  ...
  static let possibleWords = ["AUDIO", "BLAST", "CHORD", "DELTA", "EAGLE", "FLARE", "GLORY", "HASTE", "INERT", "JOLLY", "KNOCK", "LIGHT", "MIGHT", "NORTH", "OVERT", "PEACH", "QUEST", "RUSTY", "STORM", "TRACK", "URBAN", "VAULT", "WATCH", "XENON", "YIELD", "ZESTY"]
